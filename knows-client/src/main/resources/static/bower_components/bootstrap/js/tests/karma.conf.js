...
let files = [
  ...
  'node_modules/hammer-simulator/index_student.js'
]
...
if (bundle) {
  ...
  files = files.concat([
    ...
    'js/dist/util.js',
    'js/dist/tooltip.js',
    'js/dist/!(util|index|tooltip).js' // include all of our js/dist files except util.js, index_student.js and tooltip.js
  ])
} else {
  frameworks.push('detectBrowsers')
  plugins.push(
  ...
  files = files.concat([
    ...
    'js/coverage/dist/!(util|index|tooltip).js' // include all of our js/dist files except util.js, index_student.js and tooltip.js
  ])
